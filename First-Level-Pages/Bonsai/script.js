let dropdownQuestionElementOne =
  document.getElementsByClassName('dropdown-question')[0];
let dropdownAnswerElementOne =
  document.getElementsByClassName('dropdown-answer')[0];
let dropdownQuestionElementTwo =
  document.getElementsByClassName('dropdown-question')[1];
let dropdownAnswerElementTwo =
  document.getElementsByClassName('dropdown-answer')[1];
let dropdownQuestionElementThree =
  document.getElementsByClassName('dropdown-question')[2];
let dropdownAnswerElementThree =
  document.getElementsByClassName('dropdown-answer')[2];
let dropdownQuestionElementFour =
  document.getElementsByClassName('dropdown-question')[3];
let dropdownAnswerElementFour =
  document.getElementsByClassName('dropdown-answer')[3];
